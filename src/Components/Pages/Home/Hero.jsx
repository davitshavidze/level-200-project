function Hero() {
  return (
    <>
      <section className="w-full h-screen bg-[url('./blurrLesson.png')] bg-no-repeat bg-cover object-cover flex justify-center items-center max-sm:text-center">
        <div className="text-center text-white flex flex-col gap-5">
          <h2 className="text-6xl text-green-600 max-sm:text-5xl max-sm:ml-5 font-semibold">Learn from the Best.</h2>
